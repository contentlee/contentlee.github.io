    ...
    <section>
      ...
      <div className='section3'>
        <div className='shipping-notice'>
          ...
          <hr/>
          <p>대한통운 / 로젠 / 한진 <br/>
            결제 확인일 기준 3일 이내 배송(평일 기준)<br/>
            산간, 도서 지역은 배송 기일이 추가적 소요될 수 있습니다.<br/>
            재고 상황에 따라 배송 기일이 지연될 수 있습니다.<br/>
            상품은 샌프란시스코 마켓 오프라인 매장과 동시 판매로 결제 완료 후 준비 중 매장에서 판매되어 품절이 될 수 있는 점 양해 바랍니다. 
          </p>
        </div>
        <div className='detail-notice'>
          <span class='notice-title'>교환 반품 안내</span>
            ...
            <ol>
              ...
              <li>단순 변심으로 인한 교환, 환불 시에는 왕복 배송비(6,000원)을 고객님께서 부담하셔야 합니다.</li>
              <li>무통장 입금 고객님은 환불 계좌 정보를 작성해 주시기 바랍니다.</li>
